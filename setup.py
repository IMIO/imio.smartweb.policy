...
setup(
    ...
    url='https://github.com/collective/imio.smartweb.policy',
    project_urls={
        'PyPI': 'https://pypi.python.org/pypi/imio.smartweb.policy',
        'Source': 'https://github.com/collective/imio.smartweb.policy',
        'Tracker': 'https://github.com/collective/imio.smartweb.policy/issues',
    ...
    target = plone
    [console_scripts]
    update_locale = imio.smartweb.policy.locales.update:update_locale
    """,
)
